...
/**
 * The cannot contain only null validator.
 *
 * @export
 * @class CannotContainOnlyNullValidator
 * @extends {Validator}
 */
export class CannotContainOnlyNullValidator extends Validator
{
    ...
    /**
     * Creates an instance of CannotContainOnlyNullValidator.
     * @param {(string | null | undefined)} message - The custom validation message.
     * @param {(string | null | undefined)} messageKey - The custom validation message key.
     * @param {(ValidationLevel | null | undefined)} validationLevel - The custom validation level.
     * @param {(string | null | undefined)} validationContext - The custom validation context.
     * @param {(number | null | undefined)} validationPriority - The custom validation priority.
     * @memberof CannotContainOnlyNullValidator
     */
