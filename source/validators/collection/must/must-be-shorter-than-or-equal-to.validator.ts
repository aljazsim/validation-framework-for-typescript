...
/**
 * The must be shorter than or equal to validator.
 *
 * @export
 * @class MustBeShorterThanOrEqualToValidator
 * @extends {Validator}
 */
export class MustBeShorterThanOrEqualToValidator extends Validator
{
    // #region Constructors (1)

    /**
     * Creates an instance of MustBeShorterThanOrEqualToValidator.
     ...
     * @memberof MustBeShorterThanOrEqualToValidator
     */
    ...
    {
        return "Value must be shorter than or equal to {0} items.";
    }
    ...
    {
        return "MustBeShorterThanOrEqualTo";
    }
