...
/**
 * The must be longer than validator.
 *
 * @export
 * @class MustBeLongerThanValidator
 * @extends {Validator}
 */
export class MustBeLongerThanValidator extends Validator
{
    ...
    /**
     * Creates an instance of MustBeLongerThanValidator.
     ...
     * @memberof MustBeLongerThanValidator
     */
    ...
    {
        return "Value must be longer than {0} items.";
    }
