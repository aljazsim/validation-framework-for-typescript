...
export class CannotBeLessThanValidator extends Validator
{
     ...
     */
    constructor(public readonly minValue: number | string, message: string | null | undefined, validationLevel: ValidationLevel | null | undefined, validationContext: string | null | undefined, validationPriority: number | null | undefined)
    {
