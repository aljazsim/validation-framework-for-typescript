...
{
    return Validation.getValidationDecorator(new MustBeBetweenValidator(minValue, maxValue, inclusive, message, validationLevel, validationContext, validationPriority));
}
