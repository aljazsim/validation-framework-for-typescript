...
export class MustBeTypeOfValidator extends Validator
{
     ...
     */
    constructor(public type: any, message: string | null | undefined, validationLevel: ValidationLevel | null | undefined, validationContext: string | null | undefined, validationPriority: number | null | undefined)
    {
