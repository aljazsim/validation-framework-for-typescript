...
export class CannotBeTypeOfValidator extends Validator
{
     ...
     */
    constructor(public type: string, message: string | null | undefined, validationLevel: ValidationLevel | null | undefined, validationContext: string | null | undefined, validationPriority: number | null | undefined)
    {
