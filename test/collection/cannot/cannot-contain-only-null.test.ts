...
describe("CannotContainOnlyNull", () =>
{
    ...
    {
        let validator = new CannotContainOnlyNullValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotContainOnlyNullValidator("Test message.", ValidationLevel.info, "test context", 75);
