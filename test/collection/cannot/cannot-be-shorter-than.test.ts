...
describe("CannotBeShorterThan", () =>
{
    ...
    {
        let validator = new CannotBeShorterThanValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeShorterThanValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeShorterThanValidator(1, "Test message.", ValidationLevel.info, "test context", 75);
