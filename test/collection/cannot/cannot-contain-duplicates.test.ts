...
describe("CannotContainDuplicates", () =>
{
    ...
    {
        let validator = new CannotContainDuplicatesValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotContainDuplicatesValidator("Test message.", ValidationLevel.info, "test context", 75);
