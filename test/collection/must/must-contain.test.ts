...
describe("MustContain", () =>
{
    ...
    {
        let validator = new MustContainValidator(x => x > 3, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustContainValidator(x => x !== null, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustContainValidator(x => [1, 2, 3].indexOf(x) > -1, "Test message.", ValidationLevel.info, "test context", 75);
