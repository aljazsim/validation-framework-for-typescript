...
describe("MustBeNullOrEmpty", () =>
{
    ...
    {
        let validator = new MustBeNullOrEmptyValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeNullOrEmptyValidator("Test message.", ValidationLevel.info, "test context", 75);
