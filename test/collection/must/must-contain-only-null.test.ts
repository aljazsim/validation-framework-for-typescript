...
describe("MustContainOnlyNull", () =>
{
    ...
    {
        let validator = new MustContainOnlyNullValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustContainOnlyNullValidator("Test message.", ValidationLevel.info, "test context", 75);
