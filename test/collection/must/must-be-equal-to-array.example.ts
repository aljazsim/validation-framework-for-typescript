...
export class MustBeEqualToArrayExample extends Validatable
{
    ...
    @MustBeEqualToArray([1, 2, 3, null], true, "message {0}", ValidationLevel.error, null, 15)
    public value1: (number | null)[] | null = null;

    @MustBeEqualToArray([1, 2, 3, undefined], true, "message {0}", ValidationLevel.error, null, 15)
