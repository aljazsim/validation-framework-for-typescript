...
describe("CannotBeShorterThanOrEqualTo", () =>
{
    ...
    {
        let validator = new CannotBeShorterThanOrEqualToValidator(2, null, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeShorterThanOrEqualToValidator(5, null, null, ValidationLevel.error, ValidationContext.default, 0);

        assert.equal(validator.message, "Value cannot be shorter than or equal to 5 items.");
        assert.equal(validator.messageKey, "CannotBeShorterThanOrEqualTo");
    ...
    {
        let validator = new CannotBeShorterThanOrEqualToValidator(1, "Test message.", "Test message key", ValidationLevel.info, "test context", 75);
