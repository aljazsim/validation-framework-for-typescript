...
import { MustBeLongerThanExample } from "./must-be-longer-than.example";
...
describe("MustBeLongerThan", () =>
{
    ...
    {
        let validator = new MustBeLongerThanValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLongerThanValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLongerThanValidator(1, "Test message.", ValidationLevel.info, "test context", 75);
    ...
    it("should validate", () =>
    {
        let validatable = new MustBeLongerThanExample();
