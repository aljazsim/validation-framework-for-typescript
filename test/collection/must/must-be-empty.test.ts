...
describe("MustBeEmpty", () =>
{
    ...
    {
        let validator = new MustBeEmptyValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeEmptyValidator("Test message.", ValidationLevel.info, "test context", 75);
