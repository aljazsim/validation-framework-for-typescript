...
describe("MustBeFloat", () =>
{
    ...
    {
        let validator = new MustBeFloatValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeFloatValidator(3, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeFloatValidator(4, "Test message.", ValidationLevel.info, "test context", 75);
