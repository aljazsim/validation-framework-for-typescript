...
describe("MustBeInteger", () =>
{
    ...
    {
        let validator = new MustBeLessThanValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new MustBeLessThanValidator("2", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLessThanValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLessThanValidator(15, "Test message.", ValidationLevel.info, "test context", 75);
