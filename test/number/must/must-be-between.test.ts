...
describe("MustBeBetween", () =>
{
    ...
    {
        let validator = new MustBeBetweenValidator(0, 3, true, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new MustBeBetweenValidator("0", "3", false, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeBetweenValidator(-1, 1, true, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new MustBeBetweenValidator(-1, 1, false, null, ValidationLevel.error, ValidationContext.default, 0);
