...
describe("MustBeInteger", () =>
{
    ...
    {
        let validator = new MustBeIntegerValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeIntegerValidator("Test message.", ValidationLevel.info, "test context", 75);
