...
describe("MustBeInteger", () =>
{
    ...
    {
        let validator = new MustBeLessThanOrEqualToValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new MustBeLessThanOrEqualToValidator("2", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLessThanOrEqualToValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLessThanOrEqualToValidator(15, "Test message.", ValidationLevel.info, "test context", 75);
