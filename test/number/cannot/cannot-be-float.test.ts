...
describe("CannotBeFloat", () =>
{
    ...
    {
        let validator = new CannotBeFloatValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeFloatValidator(3, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeFloatValidator(4, "Test message.", ValidationLevel.info, "test context", 75);
