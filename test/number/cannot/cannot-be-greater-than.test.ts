...
import { CannotBeGreaterThanExample } from "./cannot-be-greater-than.example";
...
describe("CannotBeInteger", () =>
{
    ...
    {
        let validator = new CannotBeGreaterThanValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new CannotBeGreaterThanValidator("2", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeGreaterThanValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeGreaterThanValidator(15, "Test message.", ValidationLevel.info, "test context", 75);
    ...
    it("should validate", () =>
    {
        let validatable = new CannotBeGreaterThanExample();
