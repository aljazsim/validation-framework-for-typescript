...
describe("CannotBeInteger", () =>
{
    ...
    {
        let validator = new CannotBeLessThanOrEqualToValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new CannotBeLessThanOrEqualToValidator("2", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeLessThanOrEqualToValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeLessThanOrEqualToValidator(15, "Test message.", ValidationLevel.info, "test context", 75);
