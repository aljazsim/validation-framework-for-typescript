...
describe("CannotBeInteger", () =>
{
    ...
    {
        let validator = new CannotBeLessThanValidator(2, null, ValidationLevel.error, ValidationContext.default, 0);
        ...
        validator = new CannotBeLessThanValidator("2", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeLessThanValidator(5, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeLessThanValidator(15, "Test message.", ValidationLevel.info, "test context", 75);
