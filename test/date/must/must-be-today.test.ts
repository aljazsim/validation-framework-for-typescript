...
describe("MustBeToday", () =>
{
    ...
    {
        let validator = new MustBeTodayValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeTodayValidator("Test message.", ValidationLevel.info, "test context", 75);
