...
import { MustBeTodayValidator } from "../../../source/validators/date/must/must-be-today.validator";
import { assert2 } from "../../assert2";
import { MustBeTodayExample } from "./must-be-today.example";
...
describe("MustBeToday", () =>
{
    ...
    {
        let validator = new MustBeTodayValidator(null, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    it("should have correct default state", () =>
    {
        ...
        assert.equal(validator.message, "Value must be today's date.");
        assert.equal(validator.messageKey, "MustBeToday");
    ...
    {
        let validator = new MustBeTodayValidator("Test message.", "Test message key", ValidationLevel.info, "test context", 75);
    ...
    it("should validate", () =>
    {
        let validatable = new MustBeTodayExample();
