...
describe("MustBeDate", () =>
{
    ...
    {
        let validator = new MustBeDateValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeDateValidator("Test message.", ValidationLevel.info, "test context", 75);
