...
describe("CannotBeDateInTheFuture", () =>
{
    ...
    {
        validator = new CannotBeDateInTheFutureValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        validator = new CannotBeDateInTheFutureValidator("Test message.", ValidationLevel.info, "test context", 75);
