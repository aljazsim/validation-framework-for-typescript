...
describe("CannotBeDate", () =>
{
    ...
    {
        let validator = new CannotBeDateValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeDateValidator("Test message.", ValidationLevel.info, "test context", 75);
