...
describe("cannotBeValidDate", () =>
{
    ...
    {
        let validator = new CannotBeValidDateValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeValidDateValidator("Test message.", ValidationLevel.info, "test context", 75);
