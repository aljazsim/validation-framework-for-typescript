...
describe("cannotBeNullOrWhitespace", () =>
{
    ...
    {
        let validator = new CannotBeNullOrWhitespaceValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeNullOrWhitespaceValidator("Test message.", ValidationLevel.info, "test context", 75);
