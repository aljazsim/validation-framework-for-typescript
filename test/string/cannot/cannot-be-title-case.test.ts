...
describe("cannotBeTitleCase", () =>
{
    ...
    {
        let validator = new CannotBeTitleCaseValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeTitleCaseValidator("Test message.", ValidationLevel.info, "test context", 75);
