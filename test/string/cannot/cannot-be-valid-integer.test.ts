...
describe("cannotBeValidDate", () =>
{
    ...
    {
        let validator = new CannotBeValidIntegerValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeValidIntegerValidator("Test message.", ValidationLevel.info, "test context", 75);
