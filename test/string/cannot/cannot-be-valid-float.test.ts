...
describe("cannotBeValidDate", () =>
{
    ...
    {
        let validator = new CannotBeValidFloatValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeValidFloatValidator("Test message.", ValidationLevel.info, "test context", 75);
