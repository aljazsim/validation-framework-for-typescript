...
describe("cannotBeUpperCase", () =>
{
    ...
    {
        let validator = new CannotBeUpperCaseValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeUpperCaseValidator("Test message.", ValidationLevel.info, "test context", 75);
