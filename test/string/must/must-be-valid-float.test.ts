...
import { MustBeValidFloatExample } from "./must-be-valid-float.example";
...
describe("cannotBeValidDate", () =>
{
    ...
    {
        let validator = new MustBeValidFloatValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeValidFloatValidator("Test message.", ValidationLevel.info, "test context", 75);
    ...
    it("should validate", () =>
    {
        let validatable = new MustBeValidFloatExample();
