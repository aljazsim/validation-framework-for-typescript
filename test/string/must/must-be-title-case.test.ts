...
describe("cannotBeTitleCase", () =>
{
    ...
    {
        let validator = new MustBeTitleCaseValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeTitleCaseValidator("Test message.", ValidationLevel.info, "test context", 75);
