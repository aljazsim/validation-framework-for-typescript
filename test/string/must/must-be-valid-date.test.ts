...
describe("cannotBeValidDate", () =>
{
    ...
    {
        let validator = new MustBeValidDateValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeValidDateValidator("Test message.", ValidationLevel.info, "test context", 75);
