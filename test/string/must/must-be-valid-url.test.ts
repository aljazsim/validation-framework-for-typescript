...
describe("cannotBeValidDate", () =>
{
    ...
    {
        let validator = new MustBeValidUrlValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeValidUrlValidator("Test message.", ValidationLevel.info, "test context", 75);
