...
describe("cannotBeNullOrWhitespace", () =>
{
    ...
    {
        let validator = new MustBeNullOrWhitespaceValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeNullOrWhitespaceValidator("Test message.", ValidationLevel.info, "test context", 75);
