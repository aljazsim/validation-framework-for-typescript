...
describe("cannotBeLowerCase", () =>
{
    ...
    {
        let validator = new MustBeLowerCaseValidator(null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeLowerCaseValidator("Test message.", ValidationLevel.info, "test context", 75);
