...
describe("mustInstanceOf", () =>
{
    ...
    {
        let validator = new MustBeTypeOfValidator("string", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeTypeOfValidator("number", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeTypeOfValidator("date", "Test message.", ValidationLevel.info, "test context", 75);
