...
describe("mustBe", () =>
{
    ...
    {
        let validator = new MustBeValidator(x => x > 3, null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeValidator(x => typeof x === "string", null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new MustBeValidator(x => x !== null && x.toUpper() === x, "Test message.", ValidationLevel.info, "test context", 75);
