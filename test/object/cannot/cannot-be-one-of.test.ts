...
describe("cannotBeOneOf", () =>
{
    ...
    {
        let validator = new CannotBeOneOfValidator([1, 2, "3"], null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeOneOfValidator([21], null, ValidationLevel.error, ValidationContext.default, 0);
    ...
    {
        let validator = new CannotBeOneOfValidator(["aaa"], "Test message.", ValidationLevel.info, "test context", 75);
